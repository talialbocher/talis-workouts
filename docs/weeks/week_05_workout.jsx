...
const ILLUS = {
  ...
  "Hip thrust – 12 lb": () => (
    <SvgWrap>
      ...
      <Hd cx={88} cy={68} r={5} />
      <Ln p={[[80,70],[52,42]]} />
      <Ln p={[[52,42],[28,58],[16,58]]} />
      <Ln p={[[68,70],[64,74]]} w={1.5} />
      <Ln p={[[56,70],[52,74]]} w={1.5} />
  ...
  "Reverse lunge – 8 lb": () => (
    <SvgWrap>
      ...
      <Ln p={[[46,32],[42,42]]} w={1.5} />
      <Ln p={[[58,32],[62,42]]} w={1.5} />
    </SvgWrap>
  ),
  "Lateral lunge – 8 lb": () => (
    <SvgWrap>
  ...
  "Renegade row – 8 lb": () => (
    <SvgWrap>
      <Gnd /><Hd cx={20} cy={30} r={6} />
      <Ln p={[[20,36],[32,44],[68,54]]} />
      <Ln p={[[20,36],[30,46],[64,54]]} />
      <Ln p={[[68,54],[74,68],[72,79]]} />
      <Ln p={[[58,51],[56,64],[50,79]]} />
...
const days = [
  {
    ...
    warmup: "4 min — march in place, leg swings x15, hip circles, lateral steps x15 each way, bodyweight squat x10",
    warmupItems: ["March in place", "Leg swings", "Hip circles", "Lateral steps", "Bodyweight squat"],
    note: "Month 2 begins. Supersets A and B with 30 sec rest between rounds. 4 sets on key exercises.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "4 x 12 reps", superset: "A", note: "Fourth set added this month. Same 12 lb, but one more set means significantly more total volume. Pause 2 sec at the bottom of every rep." },
      { name: "Hip thrust – 12 lb", sets: "4 x 12 reps", superset: "A", note: "New this week — an upgrade from glute bridges. Sit with your upper back against a couch or bench, feet flat, 12 lb dumbbell on your hips. Drive hips up to full extension. Best glute exercise there is." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Carrying over from week 4 with an extra rep each side. 8 lb dumbbells at sides. Control the descent — 3 counts down." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Same as week 4. Dumbbell at chest as counterweight. Sit deep into the working hip — don't rush back to center." },
      { name: "Calf raise (single leg)", sets: "3 x 20 each side", note: "Highest rep count yet. 5-count descent. No superset — full rest between sets." },
      { name: "Step touch (finisher)", sets: "2 min continuous", note: "Month 2 starts here — push the pace from the first session." },
    ],
  ...
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Month 2 cardio goal: push the pace until you can only say a few words at a time — slightly harder than month 1. This is the low end of moderate intensity and burns noticeably more." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "If dancing, try adding short 30-sec bursts of higher intensity every few minutes. Active recovery in between. This is interval-lite — very effective." },
    ],
    cooldown: "2 min — slow walk, deep breathing, standing quad and hip flexor stretch (40 sec each side)"
  },
  {
    label: "Wed", name: "Wednesday", type: "Upper body + core", tag: "strength",
    warmup: "4 min — arm circles, shoulder rolls, cat-cow x12, band pull-aparts x15, thoracic rotation",
    warmupItems: ["Arm circles", "Shoulder rolls", "Cat-cow", "Band pull-aparts", "Thoracic rotation"],
    note: "Supersets A, B, and C. 30 sec rest between rounds. New exercises this week.",
    exercises: [
      { name: "Full push-up (or knee push-up)", sets: "4 x 10 reps", superset: "A", note: "Fourth set. Track your full reps — aim to beat your week 4 count. If you hit 10 full reps, that's a major milestone." },
      { name: "Renegade row – 8 lb", sets: "3 x 8 each side", superset: "A", note: "New this week. Start in a high plank with a dumbbell in each hand. Row one dumbbell to your hip while balancing on the other. Brutally effective for back, core, and stability simultaneously." },
      { name: "Overhead press – 12 lb", sets: "4 x 12 reps", superset: "B", note: "Fourth set. 12 lb is now your standard. Press straight up, lower 3 counts. Core braced throughout." },
      { name: "Bicep curl – 12 lb", sets: "3 x 12 reps", superset: "B", note: "Stepped up from 8 lb. The 12 lb will feel heavy — keep strict form, elbows pinned. Lower 4 counts. No swinging." },
      { name: "Plank with shoulder tap", sets: "4 x 24 taps (12 each side)", superset: "C", note: "Four taps more than week 4. Slow down the taps — less hip rotation is harder and more effective." },
      { name: "Dead bug", sets: "3 x 14 each side", superset: "C", note: "Same reps as week 4, but now paired with a harder plank — the combined core demand is higher." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Recovery is training. Month 2 demands more — Thursday protects the other four days.",
    exercises: [
      { name: "Cat-cow", sets: "2 x 12 slow reps", note: "Maintained from month 1. Your thoracic spine mobility is significantly better than 5 weeks ago. Keep building it." },
      { name: "Pigeon pose", sets: "2 x 75 sec each side", note: "Same duration as week 4. Focus on relaxing the glute of the front leg completely — tension there is the main limiter." },
      { name: "90/90 hip stretch", sets: "2 x 60 sec each side", note: "Try leaning forward over the front shin with a flat back. Deeper hip flexion than a standard sit." },
      { name: "Thread-the-needle", sets: "2 x 50 sec each side", note: "Same as week 4. Notice how automatic the movement feels now compared to week 1." },
      { name: "Supine spinal twist", sets: "2 x 60 sec each side", note: "Full minute each side. Let the shoulder blade release to the floor as you breathe out." },
      { name: "Legs-up-the-wall", sets: "1 x 5 min", note: "Five minutes. Close your eyes. This is your cortisol reset and parasympathetic recovery for the week. Non-negotiable." },
    ],
    cooldown: "5 slow deep breaths — inhale 5, hold 3, exhale 7"
  },
  {
    label: "Fri", name: "Friday", type: "Full body strength", tag: "strength",
    warmup: "4 min — side-to-side steps, hip hinges x15, goblet squat hold (12 lb, 25 sec), wrist circles",
    warmupItems: ["Side-to-side steps", "Hip hinges", "Goblet squat hold", "Wrist circles"],
    note: "Supersets A, B, and C. 30 sec rest between rounds. New exercise: Arnold press.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "4 x 14 reps", superset: "A", note: "Fourth set, two more reps than week 4. Your hamstrings are now strong enough to handle this volume. Slow the lowering to 4 counts if it feels manageable." },
      { name: "Full push-up (or knee push-up)", sets: "4 x 10 reps", superset: "A", note: "Second push-up session of the week. The cumulative fatigue makes this harder than Wednesday — that's intentional. Note your full-rep count." },
      { name: "Sumo squat – 12 lb", sets: "4 x 15 reps", superset: "B", note: "Fourth set added. Hold 12 lb at chest. Pause 2 sec at the bottom. Inner thighs and glutes should be working hard by set 3." },
      { name: "Arnold press – 8 lb", sets: "3 x 10 reps", superset: "B", note: "New this week. Start with dumbbells at shoulder height, palms facing you. As you press up, rotate palms to face forward at the top. More shoulder muscle activation than a standard press." },
      { name: "Pallof press (resistance band)", sets: "4 x 15 each side", superset: "C", note: "Fourth set. 3-sec hold at full extension. Your anti-rotation core strength is a genuine asset now." },
      { name: "Step touch (finisher)", sets: "2 min continuous", note: "End of week 5. Same finisher, higher effort. You're building real fitness — feel it." },
    ],
  ...
  },
  {
    ...
    note: "Rest. Week 5 done — month 2 is underway. The jump in volume this week was real. Let your muscles recover fully today."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest. Prep your meals. By now protein timing should be feeling more natural — aim for protein at every meal this week. Your muscle-building depends on it."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week five workout schedule</h1>
