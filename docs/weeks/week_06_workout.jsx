...
const ILLUS = {
  ...
  "Bent-over rear delt fly – 8 lb": () => (
    <SvgWrap><Gnd /><Hd cx={15} cy={28} r={5} />
      <Ln p={[[15,33],[20,40],[68,44]]} /><Ln p={[[68,44],[64,66],[60,79]]} /><Ln p={[[68,44],[74,64],[72,79]]} />
      <Ln p={[[36,41],[34,22]]} /><Ln p={[[50,42],[48,23]]} />
...
const VIDEO = {
  "Goblet squat – 8 lb": "https://www.youtube.com/results?search_query=goblet+squat+dumbbell+form+tutorial",
...
const days = [
  {
    ...
    warmup: "3 min — march in place, leg swings x10 each, hip circles, lateral steps x10 each way",
    warmupItems: ["March in place", "Leg swings", "Hip circles", "Lateral steps"],
    note: "Welcome back. 3 sets on everything this week — no pressure to push hard. Focus on feeling the movements again.",
    exercises: [
      { name: "Goblet squat – 8 lb", sets: "3 x 10 reps", superset: "A", note: "Back to 8 lb this week. After time off, lighter weight with perfect form rebuilds the movement pattern faster than heavy weight with sloppy form." },
      { name: "Hip thrust – 12 lb", sets: "3 x 10 reps", superset: "A", note: "Keep the 12 lb — hip thrusts use your largest muscles so they bounce back quickly after a break. Pause 2 sec at the top." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 10 each leg", superset: "B", note: "Nice controlled lunges. Your legs have been working hard hiking — they just need reminding of the movement pattern." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 10 each side", superset: "B", note: "Sit into the hip slowly. If your inner thighs feel sore from hiking, that's normal — they were active on uneven terrain." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Calves worked hard on hikes — they may be tight. Use a step edge and lower slowly. No superset." },
      { name: "Step touch (finisher)", sets: "90 sec continuous", note: "Slightly shorter than usual this week. Easy pace — just keep moving." },
    ],
    cooldown: "3 min — figure-4 hip stretch (60 sec each side), seated forward fold 45 sec, child's pose"
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "After a week of hiking your cardio base is solid. Keep the pace comfortable — this is active recovery, not a push day. Enjoy being back in your routine." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "Any rhythmic movement works. Keep it easy — the point this week is consistency, not intensity." },
    ],
    cooldown: "2 min — slow walk, deep breathing (4 in, 6 out x5), standing quad stretch (30 sec each side)"
  },
  {
    label: "Wed", name: "Wednesday", type: "Upper body + core", tag: "strength",
    warmup: "3 min — arm circles, shoulder rolls, cat-cow x10, thoracic rotation",
    warmupItems: ["Arm circles", "Shoulder rolls", "Cat-cow", "Thoracic rotation"],
    note: "3 sets, controlled pace. Dropping overhead press back to 8 lb and bicep curl back to 8 lb this week — rebuild before you push.",
    exercises: [
      { name: "Full push-up (or knee push-up)", sets: "3 x 8 reps", superset: "A", note: "Slightly fewer reps than week 5. Aim for quality full push-ups — if your form was breaking down in week 5, that's useful feedback. Track your full reps again as your week 6 benchmark." },
      { name: "Bent-over row – 12 lb", sets: "3 x 12 reps", superset: "A", note: "Keeping 12 lb — rows are a big muscle group and recover well. Squeeze at the top, controlled lower." },
      { name: "Overhead press – 8 lb", sets: "3 x 10 reps", superset: "B", note: "Dropping back to 8 lb this week. Shoulders are sensitive after a break — build the pattern again before adding load next week." },
      { name: "Bicep curl – 8 lb", sets: "3 x 10 reps", superset: "B", note: "Back to 8 lb. 4-count descent, elbows pinned. Focus on the squeeze at the top of each rep." },
      { name: "Dead bug", sets: "3 x 10 each side", superset: "C", note: "Core takes longer to feel back to normal after a break. Slow and deliberate — lower back pressed flat throughout." },
      { name: "Plank with shoulder tap", sets: "3 x 16 taps (8 each side)", superset: "C", note: "Slightly fewer taps than week 5. Slow taps, minimal hip rotation. Stop before form breaks." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Your body has been through a lot — 5 weeks of training, a week of hiking, now returning. Thursday is especially important this week.",
    exercises: [
      { name: "Cat-cow", sets: "2 x 12 slow reps", note: "Start here every Thursday. Breathe fully — notice if your spine feels different after a week of hiking posture." },
      { name: "Pigeon pose", sets: "2 x 75 sec each side", note: "Hips likely tight from the hiking. Sink in slowly — no forcing. Breathe into the compression on each exhale." },
      { name: "90/90 hip stretch", sets: "2 x 60 sec each side", note: "Great complement to pigeon. Together they cover internal and external hip rotation thoroughly." },
      { name: "Thread-the-needle", sets: "2 x 50 sec each side", note: "Upper back and thoracic spine may be stiff — hiking with a pack or looking at scenery creates tension here. Let the shoulder sink." },
      { name: "Supine spinal twist", sets: "2 x 60 sec each side", note: "Full passive rotation. Completely relax — no holding, just breathing and gravity." },
      { name: "Legs-up-the-wall", sets: "1 x 5 min", note: "Five minutes. After hiking daily, your legs will love this. Close your eyes, breathe slowly, let it all drain down." },
    ],
    cooldown: "5 slow deep breaths — inhale 5, hold 2, exhale 7. You earned this one."
  },
  {
    label: "Fri", name: "Friday", type: "Full body strength", tag: "strength",
    warmup: "3 min — side-to-side steps, hip hinges x10, goblet squat hold (8 lb, 20 sec), wrist circles",
    warmupItems: ["Side-to-side steps", "Hip hinges", "Goblet squat hold", "Wrist circles"],
    note: "3 sets across the board. This is your final session of the return week — finish clean, not exhausted.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 10 reps", superset: "A", note: "Your hamstrings have been well-conditioned by hiking descents. Keep 12 lb but drop to 10 reps — reestablish the pattern with full control." },
      { name: "Full push-up (or knee push-up)", sets: "3 x 8 reps", superset: "A", note: "Second push-up session this week. Same target as Wednesday — track full reps. By next week you should be back to week 5 numbers." },
      { name: "Sumo squat – 12 lb", sets: "3 x 12 reps", superset: "B", note: "12 lb stays — squats bounce back fast. No pause this week, just clean reps. Inner thighs will remind you hiking didn't train this pattern." },
      { name: "Bent-over rear delt fly – 8 lb", sets: "3 x 12 reps", superset: "B", note: "8 lb, controlled. Hinge forward, lift like wings, 3-count descent. Upper back may feel fatigued from the week — that's fine." },
      { name: "Pallof press (resistance band)", sets: "3 x 12 each side", note: "3-sec hold at full extension. Anti-rotation core work — one of the things hiking doesn't train. No superset." },
      { name: "Step touch (finisher)", sets: "90 sec continuous", note: "Shorter finisher again. End the return week on a positive note — you showed up, that's what matters." },
    ],
    cooldown: "3 min — pigeon pose (60 sec each side), supine spinal twist (45 sec each side), deep breathing x5"
  },
  {
    label: "Sat", name: "Saturday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest. You've navigated a vacation, daily hiking, and a structured return week. That's real adaptability. Next week the volume goes back up — but this time you'll be ready for it."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest. Prep your meals — protein especially. After a holiday week nutrition often slips; getting back on track with food this week will make a visible difference by week's end."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week six — return to training</h1>
        ...
        {d.isRest ? (
          ...
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
              <span style={{ fontSize: 12, color: "#6b7280" }}>{d.tag === "mobility" ? "~60-70 cal (recovery session)" : "~85-95 cal"}</span>
