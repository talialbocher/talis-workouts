...
const WARMUP_VIDEO = {
  ...
  "Butt kicks": "https://www.youtube.com/results?search_query=butt+kicks+warm+up+tutorial+low+impact",
};
...
const days = [
  {
    ...
    warmup: "3 min — high knees x20, leg swings x12 each, hip circles, lateral steps x12 each way",
    warmupItems: ["High knees", "Leg swings", "Hip circles", "Lateral steps"],
    note: "3 sets throughout — same as what you actually completed last week, now planned that way. Reps are up slightly to keep total volume equal. Supersets A and B.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Up from 13 reps. 3 sets × 15 is the same total volume as 4 sets × 11 — you get the same work in a more sustainable structure. Pause 2 sec at the bottom." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Up from 13 reps. Drive through heels, squeeze hard at the top, 2-sec hold. Your most important glute exercise." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 14 each leg", superset: "B", note: "One more rep each leg. 3-count descent, push back through the front heel. Feel the glute on the working leg." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 14 each side", superset: "B", note: "One more rep. Sit deep, pause a beat at the bottom, then drive back. Inner thighs and glutes working." },
      { name: "Calf raise (single leg)", sets: "3 x 20 each side", note: "Up from 18. 5-count descent — slow is the challenge here. No superset." },
      { name: "Low-impact skaters (finisher)", sets: "2 min continuous", note: "Wide lateral step, trail leg sweeps behind and taps the floor, push back. Keep the rhythm fast and the steps wide." },
    ],
    cooldown: "3 min — figure-4 hip stretch (60 sec each side), pigeon pose (45 sec each side), child's pose"
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Push the pace enough that conversation is difficult. Try to cover more ground than last week at the same effort — that gap is your measurable cardiovascular gain." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "Keep the intensity bursts going — 30 sec hard every 3-4 min. The contrast between easy and hard is the engine of cardio improvement." },
    ],
    cooldown: "2 min — slow walk, deep breathing (4 in, 6 out x6), standing quad stretch (40 sec each side)"
  },
  {
    ...
    note: "3 sets on everything. Reps up slightly from week 8. Supersets A, B, C — no rest between paired exercises, 30 sec rest between rounds.",
    exercises: [
      { name: "Full push-up (or knee push-up)", sets: "3 x 13 reps", superset: "A", note: "One more rep than week 8. Track your full push-up count each session — it's the clearest upper body strength marker in this program." },
      { name: "Renegade row – 8 lb", sets: "3 x 10 each side", superset: "A", note: "Same reps as week 8 — the focus this week is clean form. Hips perfectly square throughout, no rotation. If you feel yourself twisting, slow down." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 14 reps", superset: "B", note: "Two more reps. 4-count up, 4-count down. The tempo is the load — keep it strict. You should feel your shoulders working harder than they ever did with 12 lb at normal speed." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "One more rep per arm. 4-count descent. Elbows pinned. Full extension at the bottom before the next rep." },
      { name: "Bent-over row – 12 lb", sets: "3 x 15 reps", superset: "C", note: "Same as week 8. Squeeze and hold 2 sec at the top. Back flat, hinge solid." },
      { name: "Dead bug", sets: "3 x 15 each side", superset: "C", note: "One more rep. Slow and controlled — lower back pressed flat throughout every single rep." },
      { name: "Plank with shoulder tap", sets: "3 x 26 taps (13 each side)", note: "Two more taps. Slow, deliberate. Hips should barely move. No superset — full rest between sets." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Recovery is training. Your body rebuilds during rest — Thursday makes Friday and Monday better.",
    exercises: [
      { name: "Cat-cow", sets: "2 x 12 slow reps", note: "Full breath with every rep. Nine weeks in, this should feel automatic — notice how much more spinal range you have than week 1." },
      { name: "Pigeon pose", sets: "2 x 80 sec each side", note: "Five seconds longer than week 8. Fully relax the front glute — that muscle is working hard on strength days and needs this." },
      { name: "90/90 hip stretch", sets: "2 x 60 sec each side", note: "Lean forward over the front shin for the deeper version. Both hips benefit — internal and external rotation." },
      { name: "Thread-the-needle", sets: "2 x 50 sec each side", note: "Shoulder sinking lower than it did in week 1 — that's real accumulated mobility gain. Keep going." },
      { name: "Supine spinal twist", sets: "2 x 60 sec each side", note: "Full minute, full release. Let the knee drop to the floor, let the shoulder blade follow." },
      { name: "Legs-up-the-wall", sets: "1 x 5 min", note: "Five minutes. Eyes closed. Non-negotiable weekly nervous system reset." },
    ],
    cooldown: "5 slow deep breaths — inhale 5, hold 2, exhale 7"
  },
  {
    label: "Fri", name: "Friday", type: "Full body strength", tag: "strength",
    warmup: "3 min — high knees x20, hip hinges x12, goblet squat hold (12 lb, 20 sec), wrist circles",
    warmupItems: ["High knees", "Hip hinges", "Goblet squat hold", "Wrist circles"],
    note: "3 sets on everything. Reps up across the board from week 8. Supersets A and B — 30 sec rest between rounds.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 16 reps", superset: "A", note: "Up from 14. Your hamstrings are one of the strongest things you've built over nine weeks. 4-count lowering, full stretch at the bottom." },
      { name: "Full push-up (or knee push-up)", sets: "3 x 12 reps", superset: "A", note: "Up from 10. Second push-up session this week — cumulative fatigue from Wednesday is intentional. Note your full-rep count." },
      { name: "Sumo squat – 12 lb", sets: "3 x 18 reps", superset: "B", note: "Up from 16. 12 lb at chest, 2-sec pause at the bottom. By rep 15 your inner thighs should be genuinely working." },
      { name: "Arnold press – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Same reps as week 8 — focus on the rotation this week. Palms face you at the start, rotate fully so they face forward at the top. Control the arc." },
      { name: "Pallof press (resistance band)", sets: "3 x 16 each side", note: "One more rep per side. 3-sec hold at full extension. Anti-rotation core work — one of the best things you've built in this program. No superset." },
      { name: "Low-impact skaters (finisher)", sets: "2 min continuous", note: "End of week 9. Push the width of each step and the speed of your rhythm. You should feel this one." },
    ],
    cooldown: "3 min — pigeon pose (80 sec each side), supine spinal twist (60 sec each side), deep breathing x5"
  },
  {
    label: "Sat", name: "Saturday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest. Nine weeks in. The program is now calibrated to what you can actually complete — 3 solid sets beats 4 broken ones every time."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Nine weeks of consistent protein focus should be making a visible difference in how you recover between sessions. Keep it going."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week nine workout schedule</h1>
