...
const days = [
  {
    ...
    note: "Superset B is back — reverse lunge + lateral lunge — which is what was missing and making this session feel light. Superset A stays at 3 rounds too. Calf raise remains standalone at 2 rounds.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Back to 3 rounds, same 15 reps. Pause 2 sec at the bottom of each rep." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Back to 3 rounds, same 15 reps. Squeeze hard at the top, 2-sec hold." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Back as part of a real Superset B. Controlled descent, no rush." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Reintroduced this week to bring back a genuine second superset. Sit into the hip with control — this is what was making Monday feel too easy without it." },
  ...
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Unchanged — this session has never been the time problem." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "Full 20 minutes." },
    ],
    cooldown: "2 min — slow walk, deep breathing"
  },
  {
    ...
    note: "Back to 3 rounds on most exercises, keeping the lower reps from the reset. Bent-over row stays removed for now — reintroduce it once this version feels solid. Dead bug and plank up to 2 rounds.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 10 reps", superset: "A", note: "Back to 3 rounds, same 10 reps. Full reps where you can, knees for the rest — no shame in that transition mid-set." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 14 reps", superset: "A", note: "Back to 3 rounds, same 14 reps. 4-count up, 4-count down — tempo stays the focus." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 14 each arm", superset: "B", note: "Back to 3 rounds, same 14 reps. 4-count descent." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Back to 3 rounds, same 12 reps. Elbows pointing forward, not flared." },
      { name: "Dead bug", sets: "2 x 16 each side", superset: null, note: "Up to 2 rounds from the 1-round reset. Lower back flat throughout." },
      { name: "Plank hold", sets: "2 x 25 sec", superset: null, note: "Up to 2 rounds from the 1-round reset, same 25 sec. Stop the instant hips sag." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Unchanged — this session has never run long and stays valuable as is. Around 18-20 min.",
    exercises: [
      { name: "Cat-cow", sets: "2 x 10 slow reps", note: "Full breath with every rep." },
      { name: "Pigeon pose", sets: "2 x 60 sec each side", note: "Breathe into the hip, relax further each exhale." },
  ...
  },
  {
    ...
    note: "Back to 3 rounds throughout, same reps as the reset week. Arnold press stays out for now to protect the time budget.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 14 reps", superset: "A", note: "Back to 3 rounds, same 14 reps. Controlled lowering, moderate stretch." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 10 reps", superset: "A", note: "Back to 3 rounds, same 10 reps. Hands shoulder-width, extra tricep emphasis." },
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Back to 3 rounds, same 16 reps. 12 lb at chest, 2-sec pause at the bottom." },
      { name: "Pallof press (resistance band)", sets: "3 x 14 each side", superset: "B", note: "Back to 3 rounds, same 14 reps. 3-sec hold at full extension." },
    ],
  ...
  },
  {
    ...
    note: "Rest. This week rebuilds back to 3 rounds while keeping the lower rep counts — more volume than the reset, but each set should move quickly enough to stay manageable."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. If this week feels solid at 3 rounds with lower reps, next week can start nudging reps back up gradually — small increases, not a jump back to the old numbers all at once."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week thirteen workout schedule</h1>
