...
const days = [
  {
    ...
    note: "Continuing the technique-based progression from finding #4: goblet squat moves on from the 3-sec pause to 1.5-rep style — a half rep threaded into every full rep. 12 lb is the ceiling, so this is the lever now, not more reps. Lateral lunge holds at 12 for a second week; it only came back from the strain last week and needs one more clean week before a bump.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "New progression: lower to the bottom, rise halfway, back down, then stand all the way up — that's 1 rep. Reps drop from 15 to 12 since each one takes about 1.5x as long, so time under tension still goes up. If the halfway point gets sloppy, finish the set with full reps instead." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Holding steady this week — 3-sec top squeeze stays the focus while goblet squat takes on the new progression." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Holding at 12 for a second week — it only came back from the strain last week. Report how the inner thigh felt the day after and this can move up next week. Push the hips back, keep the trailing leg straight." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as last two weeks. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    note: "Holding everything steady this week — knee push-up, press, curl, and row all stay at last week's volume until there's word on whether the fuller Wednesday (row back in) stayed under 25 min. If it did, the row is first in line to move to 3 rounds.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "Holding at 12 this week. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 again while the row settles back in. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 again this week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Unchanged. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "2 x 15 reps", superset: "C", note: "Holding at 2 rounds for a second week — waiting to hear whether last week's row + full session fit inside 25 min before pushing to 3. Hinge at the hips, back flat, pull the elbows toward your hips." },
  ...
  },
  {
    ...
    note: "Holding steady here too — sumo squat, Arnold press, and Pallof press all stay at last week's volume pending word on whether Friday stayed under 25 min. If it did, Pallof press goes back to 3 rounds first.",
    exercises: [
      ...
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Holding at 16 for a second week since it only came back from the strain last week. Report how the inner thigh felt. Wide stance, toes turned out, dumbbell held at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Holding at 2 rounds — same reasoning as the row on Wednesday. Start with palms facing you, rotate outward as you press up, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 14 each side", note: "Standalone, holding at 2 rounds while the Arnold press settles back in. 3-sec hold at full extension." },
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat are both in their second week back — same question as last week: did the inner thigh feel fine the day after?"
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Same open questions as last week, now with an extra one: did Wednesday and Friday stay under 25 min with the row and Arnold press back in? Did the inner thigh hold up through lateral lunge and sumo squat? And how did the new 1.5-rep goblet squat feel — harder than the 3-sec pause, or about the same? All three shape week 17."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week sixteen workout schedule</h1>
