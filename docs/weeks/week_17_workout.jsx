...
const days = [
  {
    ...
    note: "Goblet squat's 1.5-rep style is one week in — holding it a second week before deciding whether hip thrust is ready for its own technique progression (finding #4). Lateral lunge holds at 12 for a third week: two clean weeks back from the strain with nothing reported wrong, but still no felt-fine confirmation to act on, so holding once more rather than guessing.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "Second week of the 1.5-rep style: lower to the bottom, rise halfway, back down, then stand all the way up — that's 1 rep. Holding at 12 reps again. If the halfway point gets sloppy, finish the set with full reps instead." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Third week at 3x15 with the 3-sec top squeeze — next in line for its own technique progression once there's word on how the goblet squat change landed." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Holding at 12 for a third week — two clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before moving up. Push the hips back, keep the trailing leg straight." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as the last three weeks. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    note: "Holding everything steady for a third week — knee push-up, press, curl, and row all stay at week 15's volume. Still no word on whether the fuller Wednesday (row back in) fits under 25 min. If it does, the row is first in line to move to 3 rounds.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "Holding at 12 for a third week. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 for a third week while the row settles back in. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 for a third week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Unchanged. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "2 x 15 reps", superset: "C", note: "Holding at 2 rounds for a third week — still waiting to hear whether the row plus full session fits inside 25 min before pushing to 3. Hinge at the hips, back flat, pull the elbows toward your hips." },
  ...
  },
  {
    ...
    note: "Holding steady here too for a third week — sumo squat, Arnold press, and Pallof press all stay at week 15's volume, still pending word on whether Friday fits under 25 min. If it does, Pallof press goes back to 3 rounds first.",
    exercises: [
      ...
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Holding at 16 for a third week — two clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before bumping. Wide stance, toes turned out, dumbbell held at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Holding at 2 rounds for a third week — same reasoning as the row on Wednesday. Start with palms facing you, rotate outward as you press up, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 14 each side", note: "Standalone, holding at 2 rounds for a third week while the Arnold press settles back in. 3-sec hold at full extension." },
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat are both in their third week back — same question as the last two weeks: did the inner thigh feel fine the day after?"
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Third week running the same open questions with no word back yet: did Wednesday and Friday stay under 25 min with the row and Arnold press back in? Did the inner thigh hold up through lateral lunge and sumo squat? And how did the 1.5-rep goblet squat feel? If an answer still doesn't land, week 18 will treat two clean weeks of silence as a green light to nudge the lowest-risk item — most likely the row to 3 rounds — rather than holding indefinitely."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week seventeen workout schedule</h1>
