...
const days = [
  {
    ...
    note: "Goblet squat's 1.5-rep style holds for a third week — still no word on how it landed, so hip thrust's own technique progression (finding #4) stays on hold too. Lateral lunge holds at 12 for a fourth week: three clean weeks back from the strain with nothing reported wrong, but still no felt-fine confirmation to act on. Only the Wednesday row moves this week (see that day's note) — lateral lunge and sumo squat get the higher bar of an explicit report before any change.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "Third week of the 1.5-rep style: lower to the bottom, rise halfway, back down, then stand all the way up — that's 1 rep. Holding at 12 reps again. If the halfway point gets sloppy, finish the set with full reps instead." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Fourth week at 3x15 with the 3-sec top squeeze — still next in line for its own technique progression once there's word on how the goblet squat change landed." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Holding at 12 for a fourth week — three clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before moving up. Push the hips back, keep the trailing leg straight." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as the last four weeks. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    note: "Three weeks running with no word on whether the fuller Wednesday (row back in) fits under 25 min. Rather than hold a fourth week guessing, the bent-over row moves to 3 rounds this week — pulling work is the highest program-review priority, and a rep bump on an already-tolerated exercise is a lower-risk move than bumping a previously-injured lift. Knee push-up, press, and curl hold at week 15's volume; watch the clock and report back if 3 rounds on the row pushes Wednesday over budget.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "Holding at 12 for a fourth week. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 for a fourth week while the row settles back in. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 for a fourth week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Unchanged. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "3 x 15 reps", superset: "C", note: "Moving to 3 rounds this week — three clean weeks at 2 rounds with no time-budget complaint is being treated as a green light. Hinge at the hips, back flat, pull the elbows toward your hips. Report back if this pushes Wednesday over 25 min." },
      { name: "Dead bug", sets: "2 x 16 each side", superset: "C", note: "Still paired with the row to save time. Lower back flat throughout." },
      { name: "Plank hold", sets: "2 x 30 sec", note: "Standalone. Holding at 30 sec — stop the instant your hips sag." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Around 20 min, unchanged from week 15. The standing hamstring stretch stays — lunges and RDL are both back at full volume, so hamstring care still matters.",
    exercises: [
      { name: "Standing hamstring stretch", sets: "2 x 45 sec each leg", note: "Foot forward on a low step or the floor, hinge from the hips with a flat back until you feel the stretch. No bouncing." },
  ...
  },
  {
    ...
    note: "Holding steady here too for a fourth week — sumo squat, Arnold press, and Pallof press all stay at week 15's volume, still pending word on whether Friday fits under 25 min. Only the Wednesday row moves this week; Friday's gated items still wait for their own explicit confirmation before anything changes.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 14 reps", superset: "A", note: "Unchanged. Controlled lowering, moderate stretch — not maximum range." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 10 reps", superset: "A", note: "Unchanged. Hands shoulder-width, extra tricep emphasis. Drop to knees whenever needed." },
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Holding at 16 for a fourth week — three clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before bumping. Wide stance, toes turned out, dumbbell held at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Holding at 2 rounds for a fourth week — same reasoning as before, waiting on explicit word before moving. Start with palms facing you, rotate outward as you press up, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 14 each side", note: "Standalone, holding at 2 rounds for a fourth week while the Arnold press settles back in. 3-sec hold at full extension." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as Monday." },
    ],
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat are both in their fourth week back — same question as the last three weeks: did the inner thigh feel fine the day after?"
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Four weeks running with no word on lateral lunge/sumo squat feeling fine, or on how the 1.5-rep goblet squat landed — all three still wait for an explicit report given the injury history, so they hold again. The Wednesday time-budget question went three straight weeks unanswered too, so this week applies the fallback: bent-over row moves to 3 rounds, the lowest-risk of the pending moves. Report back on all three and next week can act on real data instead of another hold."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week eighteen workout schedule</h1>
