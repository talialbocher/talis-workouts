...
const days = [
  {
    ...
    note: "Superset A stays at 3 rounds. Superset B is officially 2 rounds — matching what you actually completed last week. No pressure to push to a 3rd until hamstrings feel consistently clear.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Same as week 10. Pause 2 sec at the bottom of each rep." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Same as week 10. Squeeze hard at the top, 2-sec hold." },
      { name: "Reverse lunge – 8 lb", sets: "2 x 14 each leg", superset: "B", note: "Officially 2 sets this week — not 3. If your hamstrings feel clear throughout both sets, that's the green light to try 3 sets next week." },
      { name: "Lateral lunge – 8 lb", sets: "2 x 14 each side", superset: "B", note: "Same — 2 sets, matched to what you could do last week. Sit deep and controlled. Let this be a genuine effort at 2 rounds rather than a strained attempt at 3." },
      { name: "Calf raise (single leg)", sets: "3 x 20 each side", note: "Unchanged. 5-count descent. No superset." },
      { name: "Low-impact skaters (finisher)", sets: "2 min continuous", note: "Wide lateral steps, trail leg sweeps behind, fast rhythm. Keep it going the full 2 minutes." },
    ],
  ...
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Moderate-to-brisk pace. Walking actively helps hamstring recovery — gentle movement increases blood flow without loading them under tension." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "Full 20 minutes. Intensity bursts every few minutes if you're feeling strong." },
    ],
  ...
  },
  {
    ...
    note: "Two structural changes from week 10: plank is now a standalone exercise (not supersetted with dead bug) and the tap count is reset to 20 — a number you can complete 3 solid rounds of. Supersets A and B only.",
    exercises: [
      { name: "Full push-up (or knee push-up)", sets: "3 x 14 reps", superset: "A", note: "Same as week 10. Track your full push-up count — this number is your most honest upper body benchmark." },
      { name: "Renegade row – 8 lb", sets: "3 x 11 each side", superset: "A", note: "Same as week 10. Hips square, no rotation. This is a full-body stability exercise as much as a back exercise." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "B", note: "Same as week 10. 4-count up, 4-count down. Core braced throughout." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 16 each arm", superset: "B", note: "Same as week 10. 4-count descent, full extension at the bottom before the next rep." },
      { name: "Bent-over row – 12 lb", sets: "3 x 16 reps", superset: null, note: "Now its own straight set — no superset partner. Rest 30 sec between sets. Squeeze and hold 2 sec at the top." },
      { name: "Dead bug", sets: "3 x 16 each side", superset: null, note: "Standalone straight set. Slow and deliberate — lower back flat throughout. Rest 30 sec between sets." },
      { name: "Plank hold", sets: "3 x 35 sec", superset: null, note: "Back to a regular plank hold instead of shoulder taps — standalone, with its own 30 sec rest between sets. 35 sec is achievable without form breaking. Build from here once you can complete all 3 rounds cleanly." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Recovery day. Hamstring-specific work included again — keep this session until they feel consistently clear.",
    exercises: [
      { name: "Standing hamstring stretch", sets: "2 x 45 sec each leg", note: "Heel forward, toes up, flat-back hinge. Feel the stretch in the belly of the hamstring, not behind the knee." },
      { name: "Cat-cow", sets: "2 x 12 slow reps", note: "Full breath with every rep. Posterior chain release." },
      { name: "Pigeon pose", sets: "2 x 80 sec each side", note: "Longest hold yet. Breathe into the hip — each exhale lets you relax a little further." },
      { name: "90/90 hip stretch", sets: "2 x 60 sec each side", note: "Forward lean over the front shin for the deeper version." },
      { name: "Supine spinal twist", sets: "2 x 60 sec each side", note: "Full release. Let the knee drop, let the shoulder follow." },
      { name: "Legs-up-the-wall", sets: "1 x 5 min", note: "Five minutes, eyes closed. Gently decompresses the hamstrings and lower back." },
    ],
  ...
  },
  {
    ...
    note: "Friday was skipped in week 10 — this session is set at week 9 levels, not week 10. Completing it fully is the priority. Supersets A and B.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 16 reps", superset: "A", note: "Same as week 9. Controlled lowering, moderate stretch at the bottom — not maximum range. Stop if you feel pulling rather than tightness." },
      { name: "Full push-up (or knee push-up)", sets: "3 x 13 reps", superset: "A", note: "Week 9 level — one fewer than Wednesday, which is intentional given the cumulative week. Track your full reps." },
      { name: "Sumo squat – 12 lb", sets: "3 x 18 reps", superset: "B", note: "Week 9 level. 12 lb at chest, 2-sec pause at the bottom. Quad and glute-dominant — easier on the hamstrings." },
      { name: "Arnold press – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Week 9 level. Palms in at the start, rotate to palms forward at the top. Control the arc." },
      { name: "Pallof press (resistance band)", sets: "3 x 16 each side", note: "Week 9 level. 3-sec hold at full extension. No superset." },
      { name: "Low-impact skaters (finisher)", sets: "2 min continuous", note: "Close out the week. Wide steps, keep the rhythm. You showed up — finish strong." },
    ],
    cooldown: "3 min — standing hamstring stretch (45 sec each leg), pigeon pose (60 sec each side), supine spinal twist (45 sec each side)"
  },
  {
    label: "Sat", name: "Saturday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest. A realistic week with adjustments based on what you can actually do is more valuable than a perfect plan you can't execute."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. If hamstrings feel clear by end of this week, next week: Superset B goes back to 3 rounds, plank shoulder taps return, and Friday progresses normally."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week eleven workout schedule</h1>
