...
const days = [
  {
    ...
    note: "Strain's cleared, so lateral lunge is back in Superset B — at week 13's reps, not the 14 you were doing before the injury. Goblet squat gets a 3-sec pause instead of extra reps: 12 lb is your ceiling, so tempo is how we keep it progressing without making the session longer.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Same reps as week 14 — new tempo. Pause a full 3 sec at the bottom of every rep. The pause is the progression; it should feel harder than last week at the same weight." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Same reps, longer squeeze — hold the top for 3 sec instead of 2." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Back after two weeks out, replacing the split squat. Starting at 12 reps rather than the 14 you did in week 10 — ease back into the sideways load. Push the hips back, keep the trailing leg straight. Stop if the inner thigh pinches at all." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Skaters replace high knees now the strain has cleared — the lateral push is safe again. Wide and controlled, no jumping. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Unchanged. Now the strain's cleared you can push the pace a little — talk-but-slightly-breathless." },
  ...
  },
  {
    ...
    note: "Bent-over row is back — the real horizontal pull, so the band pull-apart moves into the warm-up where it belongs. The row returns at 2 rounds, not 3: an exercise coming back after two weeks off starts light. Press and curl hold at 15 reps this week to make room for it.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "One more rep than week 14. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 while the row comes back. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 this week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Same as week 14. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "2 x 15 reps", superset: "C", note: "Back after being cut in week 13. Hinge at the hips, back flat, pull the elbows toward your hips and squeeze the shoulder blades. Two rounds only — this is a re-entry, not a return to full volume." },
      { name: "Dead bug", sets: "2 x 16 each side", superset: "C", note: "Now paired with the row to save time. Lower back flat throughout." },
      { name: "Plank hold", sets: "2 x 30 sec", note: "Standalone. Up 2 sec from week 14 — stop the instant your hips sag." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Around 20 min, unchanged from week 14. The standing hamstring stretch stays — it's the hamstring-care routine from week 10, and with lunges and RDL both at full volume again this week it matters more, not less.",
    exercises: [
  ...
  },
  {
    ...
    note: "Sumo squat returns now the inner thigh is clear, and Arnold press comes back at 2 rounds. To pay for both inside the time budget, Pallof press drops to 2 rounds. This is the fullest Friday since week 12 — if it runs past 25 min, cut Arnold press first, not the RDL.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 14 reps", superset: "A", note: "Same as week 14. Controlled lowering, moderate stretch — not maximum range." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 10 reps", superset: "A", note: "Same as week 14. Hands shoulder-width, extra tricep emphasis. Drop to knees whenever needed." },
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Back in place of the narrow-stance goblet squat. Wide stance, toes turned out, dumbbell held at the chest — this is the inner-thigh work you've been off for two weeks. First round slowly; make sure it feels clean before you push." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Back after being cut in week 13, at 2 rounds. Start with palms facing you, rotate outward as you press up. Slower than a straight press — control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 14 each side", note: "Standalone, down to 2 rounds to make room for the Arnold press. 3-sec hold at full extension." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Skaters back now the strain has cleared. Push wide side to side, no jumping, arms swinging." },
    ],
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat both came back this week — if the inner thigh grumbles at all afterward, that's worth knowing before Monday comes round again."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Two things to report back on: did Wednesday and Friday stay under 25 min with the row and Arnold press back in, and did the inner thigh hold up? If time was tight, the fix is fewer rounds — not dropping the pull again."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week fifteen workout schedule</h1>
