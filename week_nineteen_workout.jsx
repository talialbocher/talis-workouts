...
const days = [
  {
    ...
    note: "Goblet squat's 1.5-rep style holds for a fourth week — still no word on how it landed, so hip thrust's own technique progression (finding #4) stays on hold too. Lateral lunge holds at 12 for a fifth week: four clean weeks back from the strain with nothing reported wrong, but still no felt-fine confirmation to act on. Nothing moves on Monday this week — lateral lunge and sumo squat get the higher bar of an explicit report before any change, and Wednesday's row is only in its second week at 3 rounds (see that day's note).",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "Fourth week of the 1.5-rep style: lower to the bottom, rise halfway, back down, then stand all the way up — that's 1 rep. Holding at 12 reps again. If the halfway point gets sloppy, finish the set with full reps instead." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Fifth week at 3x15 with the 3-sec top squeeze — still next in line for its own technique progression once there's word on how the goblet squat change landed." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Holding at 12 for a fifth week — four clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before moving up. Push the hips back, keep the trailing leg straight." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as the last five weeks. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    note: "Second week with the row at 3 rounds — still no word on whether it pushed Wednesday over the 25-min budget. That mirrors the two-clean-weeks bar that authorized the row's own bump last week: if this week also passes without a budget complaint, Pallof press can move to 3 rounds on Friday next. Knee push-up, press, and curl hold at week 15's volume; watch the clock and report back either way.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "Holding at 12 for a fifth week. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 for a fifth week while the row settles back in. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 for a fifth week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Unchanged. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "3 x 15 reps", superset: "C", note: "Second week at 3 rounds — no time-budget complaint yet. One more clean week here and Pallof press moves up too. Hinge at the hips, back flat, pull the elbows toward your hips. Report back if this pushes Wednesday over 25 min." },
  ...
  },
  {
    ...
    note: "Holding steady here too for a fifth week — sumo squat and Arnold press stay at week 15's volume, still waiting on their own explicit confirmation. Pallof press is the one item here in play: it's tied to Wednesday's row, and holds this week pending that second clean week (see Wednesday's note) rather than moving on its own.",
    exercises: [
      ...
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Holding at 16 for a fifth week — four clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before bumping. Wide stance, toes turned out, dumbbell held at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Holding at 2 rounds for a fifth week — same reasoning as before, waiting on explicit word before moving. Start with palms facing you, rotate outward as you press up, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 14 each side", note: "Standalone, holding at 2 rounds — tied to the Wednesday row's second clean week at 3 rounds; moves to 3 rounds next week if that budget check comes back clean. 3-sec hold at full extension." },
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat are both in their fifth week back — same question as the last four weeks: did the inner thigh feel fine the day after?"
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Five weeks running with no word on lateral lunge/sumo squat feeling fine, or on how the 1.5-rep goblet squat landed — all three still wait for an explicit report given the injury history, so they hold again. The bent-over row's fallback bump to 3 rounds is now one week old with no budget complaint; one more clean week and Pallof press follows it to 3 rounds. Report back on any of these and next week can act on real data instead of another hold."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week nineteen workout schedule</h1>
