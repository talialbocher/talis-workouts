...
const days = [
  {
    ...
    note: "First session back after two weeks away. Nothing this week is a test — the numbers come down roughly a fifth across the board to re-groove the patterns, and week 22 walks them back up. Two weeks of heavy walking kept your legs and your cardio base honest, so goblet squat and hip thrust hold 12 lb. What walking does not train is sideways loading, so lateral lunge drops to 2 rounds. The 1.5-rep goblet squat is parked for one week — plain reps here, the 1.5-rep style returns in week 22.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps", superset: "A", note: "Straight reps this week — the 1.5-rep style sits out the return week and comes back in week 22. Weight holds at 12 lb: walking kept the legs working, so this is re-grooving the pattern, not rebuilding it." },
      { name: "Hip thrust – 12 lb", sets: "3 x 12 reps", superset: "A", note: "12 lb holds, reps down from 15. Glutes come back faster than anything else after time off. Keep the 3-sec top squeeze — that part does not need deloading." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 10 each leg", superset: "B", note: "Down from 12 reps. Step straight back, controlled descent. Single-leg balance is the thing that genuinely fades over two weeks, so expect the first round to feel wobblier than the third." },
      { name: "Lateral lunge – 8 lb", sets: "2 x 10 each side", superset: "B", note: "2 rounds this week, not 3. Sideways loading is the one lower-body pattern two weeks of walking does not touch at all, and this is the movement behind the old strain — it gets the most conservative return. Back to 3 rounds in week 22 if the inner thigh is quiet the morning after." },
      { name: "Calf raise (single leg)", sets: "2 x 12 each side", note: "Standalone. Your calves did two weeks of real work and are the least detrained thing you own — reps are trimmed for the session budget, not because they need rebuilding. 5-count descent." },
      { name: "Low-impact skaters (finisher)", sets: "45 sec continuous", note: "Shortened from 60 sec for the return week, the same way week 6 handled the vacation. Easy pace — back to 60 sec next week." },
    ],
  ...
  },
  {
    ...
    note: "The one thing that did not detrain. Two weeks of walking and swimming is a real aerobic base, so this stays a full 20 minutes at normal effort — no easing in required. This is the only session in the week that is not cut.",
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Unchanged, full 20 min. Talk-but-slightly-breathless pace." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "A swim is the obvious pick this week — you have been doing it, and it is the only option here that also gives the shoulders and lats some work." },
    ],
  ...
  },
  {
    ...
    note: "Upper body detrained the most: walking does nothing for it, and swimming only partly covers the pull. Push-up, press, and curl reps come down about a quarter; row and tricep extension drop to 2 rounds. Worth being straight about the row — its move to 3 rounds only ever got one real week of training (week 18), because weeks 19 and 20 were the travel weeks. Those were not clean weeks, they were unworked weeks, so the row goes back to 2 rounds here and re-earns 3.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 9 reps", superset: "A", note: "Down from 12. Pressing is the most detrained thing in the program right now, so expect to use knees more than you did before the trip — that is the correct call, not a step back." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 11 reps", superset: "A", note: "Down from 15, 8 lb unchanged. Keep the 4-count up, 4-count down — the tempo is the load, so it is the last thing to cut." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 11 each arm", superset: "B", note: "Down from 15. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "2 x 10 reps", superset: "B", note: "2 rounds this week. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "2 x 12 reps", superset: "C", note: "Back to 2 rounds. Swimming kept the pulling muscles somewhat awake, but the loaded hinge position is what needs re-grooving — back flat, elbows toward your hips. Returns to 3 rounds in week 22 if this Wednesday runs clean." },
      { name: "Dead bug", sets: "2 x 12 each side", superset: "C", note: "Down from 16. Still paired with the row to save time. Lower back flat throughout." },
      { name: "Plank hold", sets: "2 x 20 sec", note: "Standalone, down from 30 sec. Core is what fades fastest across two weeks off — stop the instant your hips sag rather than grinding out the clock." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Rebuilt for the trip rather than for the training week. Two weeks of walking loads the calves and shortens the hip flexors, and long flights stiffen both — so a calf/soleus stretch and a kneeling hip flexor stretch come in, 90/90 sits out one week, and pigeon and the spinal twist each give up time to pay for them. Still about 20 min. The standing hamstring stretch stays put, as always.",
    exercises: [
      { name: "Standing hamstring stretch", sets: "2 x 45 sec each leg", note: "Unchanged. Foot forward on a low step or the floor, hinge from the hips with a flat back. No bouncing." },
      { name: "Calf + soleus wall stretch", sets: "2 x 45 sec each leg", note: "New this week, and the most useful thing on the list after two weeks on your feet. Hands on a wall, back leg straight with the heel down for the first 45 sec, then bend that knee slightly for the second to reach the soleus underneath." },
      { name: "Cat-cow", sets: "2 x 10 slow reps", note: "Unchanged. Full breath with every rep." },
      { name: "Kneeling hip flexor stretch", sets: "2 x 45 sec each side", note: "New this week, replacing 90/90 for one week. Back knee down, front foot forward, squeeze the back glute and tuck the pelvis before leaning in — that is what actually reaches the hip flexor. Walking plus long flights shortens this more than anything." },
      { name: "Pigeon pose", sets: "2 x 45 sec each side", note: "Down from 60 sec to make room for the two new stretches. Breathe into the hip, relax further each exhale." },
      { name: "Overhead tricep stretch", sets: "1 x 30 sec each arm", note: "Unchanged. Reach one arm overhead, bend the elbow, gently pull with the other hand." },
      { name: "Supine spinal twist", sets: "1 x 45 sec each side", note: "Down to 1 round this week. Full release, let the knee drop completely." },
      { name: "Legs-up-the-wall", sets: "1 x 5 min", note: "Up from 4 min. Two weeks of walking and a flight home is exactly what this is for. Eyes closed." },
    ],
  ...
  },
  {
    ...
    note: "Same logic as Monday. RDL reps come down hardest — walking is not the eccentric hamstring work that hiking was before the week-6 return, so the hinge gets the careful treatment. Sumo squat and Pallof press both drop to 2 rounds. Pallof's move to 3 rounds landed in week 20, which was a travel week, so it was never actually trained; it re-earns the bump rather than keeping it on paper.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 10 reps", superset: "A", note: "Down from 14, 12 lb held. Controlled lowering, moderate range — not maximum. Hamstrings did not get the eccentric loading on this trip that they got hiking before week 6, so this is the lift to be patient with." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 7 reps", superset: "A", note: "Down from 10, matching Wednesday's pressing cut. Hands shoulder-width, extra tricep emphasis. Drop to knees whenever needed." },
      { name: "Sumo squat – 12 lb", sets: "2 x 12 reps", superset: "B", note: "2 rounds and fewer reps. Wide stance is adductor work — the same tissue as the old strain, and the other pattern walking does not train. Wide stance, toes turned out, dumbbell at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 9 reps", superset: "B", note: "Reps down from 12, still 2 rounds. Palms facing you to start, rotate outward as you press, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "2 x 12 each side", note: "Standalone, back to 2 rounds. The 3-round version was written for week 20 and never trained, so it does not carry over. 3-sec hold at full extension." },
      { name: "Low-impact skaters (finisher)", sets: "45 sec continuous", note: "Shortened to 45 sec, same as Monday." },
    ],
  ...
  },
  {
    ...
    note: "Rest or a gentle walk — you have had plenty of practice at that lately. The thing to notice this week: how did Monday and Wednesday feel the morning after? General soreness after two weeks off is expected and fine. Sharp, one-sided, or inner-thigh specific is not — report that and week 22 will hold instead of climbing."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Week 21 was a return week, so none of these numbers are a benchmark — week 22 moves them back toward week 20's, and week 23 lands them fully if this week goes cleanly. Three things worth reporting: (1) did anything feel harder than expected, especially the lunges and the row; (2) how did the inner thigh handle lateral lunge and sumo squat coming back cold; (3) the 1.5-rep goblet squat returns next week, and how it feels is still the open question from six weeks ago. Also note that weeks 19 and 20 were never trained — the row's and Pallof's 3-round bumps went back down here because they were only ever clean on paper."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week twenty-one workout schedule</h1>
        ...
        {d.isRest ? (
          ...
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
              <span style={{ fontSize: 12, color: "#6b7280" }}>{d.tag === "mobility" ? "~50-60 cal (recovery session)" : "~75-85 cal"}</span>
