...
const days = [
  {
    ...
    note: "Reps land at week 20's levels this week — the top of the range the program has actually run before, not new territory. Lateral lunge is the one exception: its reps are already at week 20's 12, and its third round still waits on an explicit felt-fine report for the inner thigh. Week 25 Monday came and went without a complaint, which is encouraging but is not that report.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps", superset: "A", note: "Up to 12 — week 20's number, still 1.5-rep style: full depth, halfway up, back down, then all the way up — that whole sequence is one rep. This is the one that's gone unreported for twelve weeks now — how it feels is genuinely useful information whenever it comes in." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Up to 15 — back at week 20's number. Keep the 3-sec squeeze at the top." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Up to 12 each leg, back at week 20's number. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "2 x 12 each side", superset: "B", note: "Holding exactly where week 25 left it — reps already at week 20's 12, rounds still at 2. Its third round is the one thing in the program waiting on a specific answer: how the inner thigh feels the morning after. Say the word and it moves." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, up to 15 each side — week 20's number. 5-count descent, full stretch at the bottom." },
  ...
  },
  {
    ...
    note: "Normal effort, unchanged. Cardio is already at full length, so a ramp week changes nothing here — and after a Wednesday rebuild it is worth having one day that asks nothing new.",
    exercises: [
  ...
  },
  {
    ...
    note: "Wednesday is rebuilt around your report: the third round of overhead press died because it was supersetted straight after knee push-ups, so the same shoulders and triceps were doing both movements back to back with no recovery. That is a structural problem, not a strength one, so the fix is structural. Overhead press now goes FIRST, while you are fresh, paired with the bent-over row — a pull, so the pressing muscles rest for a full round instead of working through it. Knee push-ups move to Superset B with the dead bug. The press stays at 3 x 13 rather than dropping: it should feel like a different exercise in this slot, and changing the slot and the reps at once would leave us not knowing which one helped. If the third round is still a grind here, the answer is fewer reps with the 4-count tempo intact — never faster reps.",
    exercises: [
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 13 reps", superset: "A", note: "MOVED TO FIRST, and holding at 13. This is the one that fell apart last week, and the reason was that it came second behind push-ups. Now it is the first thing you do, paired with a pull instead of another press. 4-count up, 4-count down — the tempo is the load here, so if the third round gets hard, drop to 11 reps and keep the count rather than speeding up." },
      { name: "Bent-over row – 12 lb", sets: "3 x 14 reps", superset: "A", note: "Up to 14, one off week 18's 15. Now paired with the overhead press on purpose: pulling gives the shoulders and triceps a full round to recover between pressing sets, which is exactly what was missing. Back flat, elbows driving toward your hips, no yanking with the lower back." },
      { name: "Knee push-up (progressing to full)", sets: "3 x 11 reps", superset: "B", note: "Holding at 11, and moved out of the press superset. Not because push-ups were the problem — they were fine — but because stacking them in front of the press was. Knees whenever you need them, the rep still counts." },
      { name: "Dead bug", sets: "2 x 16 each side", superset: "B", note: "Up to 16 each side, back at week 20's number. Now paired with the push-up, so the chest and triceps get a core exercise to rest behind. Lower back stays flat — shorten the range before you let it arch." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 14 each arm", superset: "C", note: "Up to 14 each arm, one short of week 20's 15 — Wednesday is not the day to land everything at once. 4-count descent, full extension at the bottom, no swing from the hips." },
      { name: "Overhead tricep extension – 8 lb", sets: "2 x 12 reps", superset: "C", note: "Up to 12, still 2 rounds. Elbows pointing forward rather than flared. This is still the designated trim if Wednesday runs past 25 minutes — cut this, not the row and not the press." },
      { name: "Plank hold", sets: "2 x 30 sec", note: "Standalone, up to 30 sec — week 20's number. Stop the moment your hips sag rather than grinding out the clock — a shorter honest hold beats a longer sagging one." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Unchanged — the standard seven-stretch routine. Mobility does not ramp with the strength days, and the standing hamstring stretch is untouched, as always.",
    exercises: [
      ...
      { name: "90/90 hip stretch", sets: "2 x 45 sec each side", note: "Both knees at right angles, sit tall first, then walk the hands forward over the front shin. Stop where it is a stretch, not a pinch." },
      { name: "Pigeon pose", sets: "2 x 60 sec each side", note: "Holding at the full 60 sec. Prop the hip on a cushion if the knee complains." },
      ...
      { name: "Supine spinal twist", sets: "2 x 45 sec each side", note: "Holding at 2 rounds. Let the knee drop completely and keep both shoulders on the floor." },
      { name: "Legs-up-the-wall", sets: "1 x 4 min", note: "Standard 4 min. Eyes closed, nothing else going on." },
    ],
  ...
  },
  {
    ...
    note: "Friday lands fully at week 20's numbers — no round bump anywhere in the week this time. Wednesday got a fatigue report, and the right response to that is to fix the structure and finish the rep ramp, not to add a round somewhere else in the same week. Sumo squat gains reps and holds at 2 rounds, same felt-fine gate as the lateral lunge. Watch the same pairing question here that broke Wednesday: close-grip push-up sits behind the RDL, which is legs, so the triceps come to it fresh — say so if that is not how it feels.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 14 reps", superset: "A", note: "Up to 14 — week 20's number, 12 lb held. Controlled lowering, moderate range — stop where you feel the hamstring stretch, not where the back rounds." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 10 reps", superset: "A", note: "Up to 10, week 20's number. Hands shoulder-width for the tricep emphasis. Knees whenever needed." },
      { name: "Sumo squat – 12 lb", sets: "2 x 16 reps", superset: "B", note: "Up to 16, week 20's reps, still 2 rounds. Wide stance is adductor work — same tissue as the old strain, so it follows the lateral lunge's schedule rather than leading it, and gains reps rather than a round. Toes turned out, dumbbell at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Up to 12, week 20's number. It is a press, but it is 2 rounds on the back half of Friday rather than stacked behind another press. Palms facing you to start, rotate outward as you press, and control the rotation on the way down too." },
      { name: "Pallof press (resistance band)", sets: "3 x 14 each side", note: "Up to 14 each side at 3 rounds — fully back to week 20. It kept its third round from last week without complaint. If Friday runs long, this is still the round to drop first. 3-sec hold at full extension, ribs down, and do not let the torso rotate toward the band." },
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Two things worth noticing this week. First, whether the overhead press felt different in its new slot — that is the whole point of the change. Second, the inner thigh after Monday and Friday: general, even, both-sides soreness is expected and fine, but sharp, one-sided, or specifically inner-thigh soreness from lateral lunge or sumo squat is the one thing that should stop the next climb."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Week 26 is the first week in a long stretch built on a real report rather than an assumption: you trained week 25 and told me the third round of overhead press fell apart after the push-ups. That is exactly the kind of detail that changes a program, and it is why Wednesday looks different this week rather than just heavier. Every other day lands at week 20's numbers — the top of the range this program has actually run — and no exercise gains a round anywhere in the week. Worth reporting before next week: (1) whether the overhead press held up in its new first slot, and whether the row felt like a rest or like more work; (2) how the inner thigh handled lateral lunge and sumo squat, which is the one answer still holding two movements at 2 rounds; (3) whether Wednesday fit inside 25 minutes after the reshuffle; (4) how the 1.5-rep goblet squat feels, now at week 20's 12 reps and unanswered thirteen weeks running."
  }
];
const tagStyles = {
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week twenty-six workout schedule</h1>
        ...
        {d.isRest ? (
          ...
          <>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
              <span style={{ fontSize: 12, color: "#6b7280" }}>{d.tag === "mobility" ? "~50-60 cal (recovery session)" : "~90-100 cal"}</span>
