...
const days = [
  {
    ...
    note: "Week 22 — the ramp back, per the plan written into week 21. No word has come back on how the return week actually felt, but that plan was pre-written rather than left open, so it goes ahead as scheduled: lateral lunge is back to 3 rounds (it's the movement behind the old strain, and the only lower-body item named for this week's restore), and the 1.5-rep goblet squat returns unchanged. Everything else steps about halfway back to week 20's numbers — week 23 lands the rest if nothing reports as sore or off.",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "Back to the 1.5-rep style: full depth, halfway up, back down, then stand all the way — that's 1 rep. Reps hold at 12; this is a technique restore, not a load change. Still the open question from nine weeks ago: how does this actually feel? Worth reporting." },
      { name: "Hip thrust – 12 lb", sets: "3 x 14 reps", superset: "A", note: "12 lb holds, reps step up from 12 to 14 — about halfway back to week 20's 15. Keep the 3-sec top squeeze." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 11 each leg", superset: "B", note: "Up from 10 to 11, on the way back to 12. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 11 each side", superset: "B", note: "Back to 3 rounds — the one item on the week-21 plan named specifically for this week's restore, since this is the movement behind the old strain. Reps step to 11, landing at 12 in week 23. Push the hips back, trailing leg straight, and report if the inner thigh says otherwise." },
      { name: "Calf raise (single leg)", sets: "2 x 14 each side", note: "Standalone. Up from 12 to 14, on the way back to 15. 5-count descent." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Back to a full 60 sec, same as before the travel break." },
    ],
  ...
  },
  {
    ...
    note: "Unchanged, as always — this session never got cut and doesn't need a ramp. Full 20 minutes at normal effort.",
    exercises: [
      { name: "Brisk walk or light cycling", sets: "20 min", note: "Unchanged. Talk-but-slightly-breathless pace." },
      { name: "Alternatively: dance or swim", sets: "20 min", note: "Full 20 minutes. Any rhythmic, sustained movement counts — keep the stops to a minimum." },
    ],
  ...
  },
  {
    ...
    note: "Same ramp logic as Monday. Bent-over row returns to 3 rounds — its own item on the week-21 plan — while overhead tricep extension holds one more week at 2 rounds to keep today's time budget in check now that the row's third round is back. Report if this session runs long; tricep extension is the one to trim further before touching the row again.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 11 reps", superset: "A", note: "Up from 9 to 11, on the way back to 12. Full reps where you can, knees for the rest." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 14 reps", superset: "A", note: "Up from 11 to 14, on the way back to 15. Keep the 4-count up, 4-count down." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 14 each arm", superset: "B", note: "Up from 11 to 14, on the way back to 15. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "2 x 11 reps", superset: "B", note: "Holds at 2 rounds for one more week to make room for the row's third round; reps step up from 10 to 11. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "3 x 14 reps", superset: "C", note: "Back to 3 rounds, per the week-21 plan. Reps step to 14, landing at 15 in week 23. Back flat, elbows toward the hips — report if Wednesday tips over budget with this and Pallof both back at full rounds." },
      { name: "Dead bug", sets: "2 x 14 each side", superset: "C", note: "Up from 12 to 14. Still paired with the row to save time. Lower back flat throughout." },
      { name: "Plank hold", sets: "2 x 25 sec", note: "Standalone. Up from 20 to 25 sec, on the way back to 30 — stop the instant your hips sag." },
    ],
  ...
  },
  {
    ...
    warmup: null,
    note: "Travel is two weeks behind now, so the two stretches added for it — calf + soleus wall stretch and kneeling hip flexor stretch — step back out, and 90/90 hip stretch returns to its usual spot, per the week-21 plan. Pigeon pose and supine spinal twist are back to their full week-20 durations, and legs-up-the-wall comes back down to 4 min from the travel week's 5. Back to the standard seven-stretch Thursday, about 20 min.",
    exercises: [
      ...
      { name: "Pigeon pose", sets: "2 x 60 sec each side", note: "Back to 60 sec, up from the travel week's 45. Breathe into the hip, relax further each exhale." },
      { name: "90/90 hip stretch", sets: "2 x 45 sec each side", note: "Back in this week, unchanged at 45 sec each side. Forward lean over the front shin for the deeper version." },
      ...
      { name: "Supine spinal twist", sets: "2 x 45 sec each side", note: "Back to 2 rounds, up from 1. Full release, let the knee drop completely." },
      { name: "Legs-up-the-wall", sets: "1 x 4 min", note: "Back down to 4 min from the travel week's 5. Eyes closed." },
    ],
  ...
  },
  {
    ...
    note: "Same ramp as the rest of the week. Pallof press returns to 3 rounds — its own item on the week-21 plan, completing the same reintroduction the row led on Wednesday. Sumo squat holds one more week at 2 rounds: it carries the same adductor reasoning as Monday's lateral lunge, but only lateral lunge was named in the week-21 plan for this week's restore, so sumo squat waits for week 23.",
    exercises: [
      { name: "Romanian deadlift – 12 lb", sets: "3 x 12 reps", superset: "A", note: "Up from 10 to 12, on the way back to 14. Controlled lowering, moderate range — not maximum." },
      { name: "Close-grip push-up (or knee)", sets: "3 x 9 reps", superset: "A", note: "Up from 7 to 9, on the way back to 10. Hands shoulder-width, extra tricep emphasis. Drop to knees whenever needed." },
      { name: "Sumo squat – 12 lb", sets: "2 x 14 reps", superset: "B", note: "Holds at 2 rounds for one more week — same adductor reasoning as lateral lunge, but only lateral lunge was named in the week-21 plan for this week's restore. Reps step up from 12 to 14, on the way back to 16. Wide stance, toes turned out, dumbbell at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 11 reps", superset: "B", note: "Up from 9 to 11, on the way back to 12. Palms facing you to start, rotate outward as you press, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "3 x 13 each side", note: "Standalone. Back to 3 rounds, per the week-21 plan — completes the same reintroduction as the row. Reps step to 13, landing at 14 in week 23. 3-sec hold at full extension." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Back to 60 sec, same as Monday." },
    ],
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Worth noticing this week: how do lateral lunge and bent-over row's third round, and the 1.5-rep goblet squat, feel the morning after? That's the read week 23 needs before landing the rest of the ramp."
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Week 22 restored lateral lunge, bent-over row, and Pallof press to 3 rounds, brought back the 1.5-rep goblet squat and the standard Thursday mobility routine, and stepped every other number about halfway back to week 20's level. Week 23 is set to land the rest of the ramp — unless something reports as sore, tight, or off, in which case it holds here instead of climbing further. Sumo squat and overhead tricep extension are the two items still sitting one round back; both are next in line."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week twenty-two workout schedule</h1>
