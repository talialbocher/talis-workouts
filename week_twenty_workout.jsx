...
const days = [
  {
    ...
    note: "Goblet squat's 1.5-rep style holds for a fifth week — still no word on how it landed, so hip thrust's own technique progression (finding #4) stays on hold too. Lateral lunge holds at 12 for a sixth week: five clean weeks back from the strain with nothing reported wrong, but still no felt-fine confirmation to act on. Nothing moves on Monday this week — lateral lunge and sumo squat get the higher bar of an explicit report before any change; Pallof press is the one exercise progressing this week, and it's on Friday (see that day's note).",
    exercises: [
      { name: "Goblet squat – 12 lb", sets: "3 x 12 reps (1.5-rep style)", superset: "A", note: "Fifth week of the 1.5-rep style: lower to the bottom, rise halfway, back down, then stand all the way up — that's 1 rep. Holding at 12 reps again. If the halfway point gets sloppy, finish the set with full reps instead." },
      { name: "Hip thrust – 12 lb", sets: "3 x 15 reps", superset: "A", note: "Sixth week at 3x15 with the 3-sec top squeeze — still next in line for its own technique progression once there's word on how the goblet squat change landed." },
      { name: "Reverse lunge – 8 lb", sets: "3 x 12 each leg", superset: "B", note: "Unchanged. Step straight back, controlled descent." },
      { name: "Lateral lunge – 8 lb", sets: "3 x 12 each side", superset: "B", note: "Holding at 12 for a sixth week — five clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before moving up. Push the hips back, keep the trailing leg straight." },
      { name: "Calf raise (single leg)", sets: "2 x 15 each side", note: "Standalone, unchanged. 5-count descent, controlled." },
      { name: "Low-impact skaters (finisher)", sets: "60 sec continuous", note: "Holding at 60 sec, same as the last six weeks. This is what keeps the session near 100 cal." },
    ],
  ...
  },
  {
    ...
    note: "Third week with the row at 3 rounds — still no budget complaint, which is what unlocks Pallof press moving to 3 rounds on Friday this week (see that day's note). Knee push-up, press, and curl hold at week 15's volume; watch the clock and report back either way — if Wednesday or Friday tips over 25 min now that both are at full volume, drop the newer bump (Pallof) back down rather than touching the row.",
    exercises: [
      { name: "Knee push-up (progressing to full)", sets: "3 x 12 reps", superset: "A", note: "Holding at 12 for a sixth week. Full reps where you can, knees for the rest — dropping mid-set is smart pacing." },
      { name: "Overhead press – 8 lb (tempo)", sets: "3 x 15 reps", superset: "A", note: "Holding at 15 for a sixth week. 4-count up, 4-count down — tempo stays the load." },
      { name: "Alternating bicep curl – 8 lb", sets: "3 x 15 each arm", superset: "B", note: "Holding at 15 for a sixth week. 4-count descent, full extension at the bottom." },
      { name: "Overhead tricep extension – 8 lb", sets: "3 x 12 reps", superset: "B", note: "Unchanged. Elbows pointing forward, not flared." },
      { name: "Bent-over row – 12 lb", sets: "3 x 15 reps", superset: "C", note: "Third week at 3 rounds — no time-budget complaint yet; that's what let Pallof press move up to 3 rounds this week too. Hinge at the hips, back flat, pull the elbows toward your hips. Report back if Wednesday tips over 25 min now that both supersets are at full volume." },
  ...
  },
  {
    ...
    note: "Holding steady here too for a sixth week — sumo squat and Arnold press stay at week 15's volume, still waiting on their own explicit confirmation. Pallof press moves to 3 rounds this week: the row cleared its two-clean-week bar (weeks 18–19, no budget complaint), and Pallof follows the same bar to complete the row/Pallof reintroduction.",
    exercises: [
      ...
      { name: "Sumo squat – 12 lb", sets: "3 x 16 reps", superset: "B", note: "Holding at 16 for a sixth week — five clean weeks back from the strain with nothing reported wrong, but still waiting on that felt-fine confirmation before bumping. Wide stance, toes turned out, dumbbell held at the chest." },
      { name: "Arnold press – 8 lb", sets: "2 x 12 reps", superset: "B", note: "Holding at 2 rounds for a sixth week — same reasoning as before, waiting on explicit word before moving. Start with palms facing you, rotate outward as you press up, control the rotation." },
      { name: "Pallof press (resistance band)", sets: "3 x 14 each side", note: "Standalone, now at 3 rounds — completes the two-clean-week bar the row already cleared (weeks 18–19, no budget complaint). 3-sec hold at full extension." },
  ...
  },
  {
    ...
    note: "Rest or a gentle walk. Lateral lunge and sumo squat are both in their sixth week back — same question as the last five weeks: did the inner thigh feel fine the day after?"
  },
  {
    label: "Sun", name: "Sunday", type: "Rest", tag: "rest", isRest: true,
    note: "Rest and meal prep. Six weeks running with no word on lateral lunge/sumo squat feeling fine, or on how the 1.5-rep goblet squat landed — all three still wait for an explicit report given the injury history, so they hold again. Pallof press has now followed the bent-over row to 3 rounds, completing that reintroduction — both are two clean weeks past their bumps with nothing reported wrong. Report back on any of the still-open items and next week can act on real data instead of another hold."
  }
];
...
export default function WorkoutSchedule() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", maxWidth: 680, margin: "0 auto", padding: "1.5rem 1rem 3rem" }}>
      <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 4 }}>Week twenty workout schedule</h1>
